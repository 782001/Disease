...
class ShowRetMarakezScreens extends StatelessWidget {
  ShowRetMarakezScreens({
    Key? key,
    required this.retmarakezModel,
  }) : super(key: key);
  final RetData? retmarakezModel;
  @override
  Widget build(BuildContext context) {
    final Uri _url1 = Uri.parse(
      "${retmarakezModel!.retMarakez!.first.mara_loc1!}",
    );
    final Uri _url2 = Uri.parse(
      "${retmarakezModel!.retMarakez!.first.mara_loc2!}",
    );
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  CustomText(
                                    text:
                                        "${retmarakezModel!.retMarakez!.first.maraTitle1!}",
                                  ...
                                  CustomText(
                                    text:
                                        "رقم الهاتف:   ${retmarakezModel!.retMarakez!.first.maraPhone1!}",
                                    color: AppColors.black,
                                    fontWeight: FontWeight.bold,
                                    size: 15.sp,
                                    maxLines: 10,
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  CustomText(
                                    text:
                                        "${retmarakezModel!.retMarakez!.first.maraTitle2!}",
                                    color: AppColors.black,
                                    fontWeight: FontWeight.bold,
                                    size: 15.sp,
                                    maxLines: 10,
                                  ...
                                  CustomText(
                                    text:
                                        "رقم الهاتف:   ${retmarakezModel!.retMarakez!.first.maraPhone2!}",
                                    color: AppColors.black,
                                    fontWeight: FontWeight.bold,
                                    size: 15.sp,
                                    maxLines: 10,
                                  ...
                                  Container(
                                    ...
                                    child: MaterialButton(
                                      onPressed: () {
                                        // MapsLauncher.launchCoordinates(
                                        //     // 31.3783735, 30.098829298540384
                                        //     // 31.3783735
                                        //     marakezModel!
                                        //             .marakez!.first.maralat2! ,
                                        //     marakezModel!
                                        //         .marakez!.first.maralong2!);
                                        GoLocation(_url2);
                                      },
                                      child: const Text(
                                        'اذهب للموقع',
